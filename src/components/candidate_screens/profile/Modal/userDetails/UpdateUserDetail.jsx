...
import { updateLicense } from "../../../../../api/candidate/candidate.class";
...
export default function CustomModal({
  ...
  const initialValues = {
    ...
    // passport_number: data?.passport_number ? data?.passport_number : "",
    // visa_number: data?.visa_number ? data?.visa_number : "",
